...
S = {
  ...
  "items": [
   ...
   {"icon": "bell", "base": "automatizacion-de-procesos", "link": "Ver automatización de procesos",
    ...
    "bullets": ["Recordatorio por WhatsApp antes de cada cita, con opción de confirmar o cambiarla.",
                "Si alguien cancela, se avisa a las clientas que estaban en lista de espera.",
                "Control de bonos: cuántas sesiones quedan y cuándo toca la siguiente.",
                "Avisos de seguimiento en tratamientos por fases, como depilación láser o corporales."],
    "result": "menos ausencias, menos huecos muertos y ninguna sesión de bono olvidada."},
   {"icon": "star", "base": "resenas-automaticas-google", "link": "Ver reseñas automáticas en Google",
    "title": "Más reseñas en Google después de cada tratamiento",
    "desc": "Al terminar la cita, tu clienta recibe un mensaje amable de agradecimiento con el enlace directo para valorar tu centro en Google.",
    "bullets": ["Se envía cuando la experiencia está más reciente.",
                "Llega a todas las clientas por igual, como exigen las normas de Google.",
 ...
 "steps": {
  ...
  "h2": "De la primera conversación a tu centro funcionando",
  "items": [
   ("Auditoría gratuita de tu centro",
    "Revisamos cómo gestionas hoy las citas, los mensajes, los bonos y las reseñas, y te decimos qué merece la pena automatizar. <strong>Sin coste y sin compromiso.</strong>"),
   ("Lo configuramos a tu medida",
    "Cargamos tu carta de tratamientos, horarios, precios y tu forma de hablar. Conectamos tu WhatsApp y tu agenda."),
   ("Lo activamos y te acompañamos",
    "Te enseñamos a usarlo con tus propias citas y seguimos ajustándolo contigo siempre que lo necesites."),
  ],
 },
 ...
 "faq": {
  ...
  "items": [
   ("¿Funciona con el programa de citas que ya uso en mi centro?",
    "<p>Depende del programa. Si tu agenda permite conectarse con otras herramientas o se sincroniza con Google Calendar, el asistente puede reservar directamente en ella. Si no, te proponemos la alternativa más sencilla para que no tengas que llevar dos agendas.</p>"
    "<p>Lo comprobamos en la <a href=\"https://verantiapro.es/servicios/auditoria-de-procesos/\">auditoría gratuita</a>, antes de que decidas nada.</p>"),
   ("¿El asistente puede dar precios y recomendar tratamientos?",
    "<p>Sí, siempre a partir de la información que tú le das: tu carta, tus precios, tus bonos y tus promociones. Puede explicar en qué consiste cada tratamiento y orientar a la clienta.</p>"
    "<p>Lo que no hace es inventar: si le preguntan algo que no está en tu información, lo dice con naturalidad y te pasa la conversación.</p>"),
   ("¿Qué pasa si una clienta pregunta por contraindicaciones o temas de salud?",
    "<p>El asistente está configurado para no dar consejos de salud. Si una clienta menciona alergias, embarazo, medicación o cualquier duda médica, le explica con amabilidad que una profesional del centro la atenderá personalmente, y te avisa.</p>"
    "<p>En estética, esa conversación siempre debe tenerla una persona.</p>"),
   ("¿Cómo se protegen los datos de mis clientas?",
    "<p>Trabajamos sobre tus propias cuentas y herramientas, y firmamos contigo el contrato de encargado de tratamiento que exige el RGPD. Tus clientas son tuyas y puedes retirarnos el acceso cuando quieras.</p>"
    "<p>Además configuramos el asistente para que no recoja por chat datos de salud, que la ley protege de forma especial.</p>"),
   ...
   ("¿Trabajáis solo con centros de estética de Valladolid?",
    "<p>Somos una agencia de Valladolid y nos gusta visitar los centros en persona, pero todo lo que hacemos funciona igual en remoto.</p>"
    "<p>Trabajamos con centros de estética de toda Castilla y León y del resto de España.</p>"),
  ],
 },
